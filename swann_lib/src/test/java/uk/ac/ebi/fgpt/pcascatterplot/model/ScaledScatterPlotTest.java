...
public class ScaledScatterPlotTest {
  ...
  public void testExtractEverythingInRegion() {
    ...
    assertEquals(2, newScatterPlot.extractEverythingInRectangularRegion(50, 50, 100, 100, Type.UNSCALED).size());
    assertEquals(1, newScatterPlot.extractEverythingInRectangularRegion(55, 55, 100, 100, Type.UNSCALED).size());
